...
const scheduleItems = [
	// Day 1
	{
		...
		time: dayjs('2/24/2023 09:00', timeFormat)
	},
	{
		title: 'Sponsor Fair',
		time: dayjs('2/24/2023 09:00', timeFormat),
		end: dayjs('2/24/2023 11:00', timeFormat)
	},
	{
		title: 'Doors Close',
		time: dayjs('2/24/2023 11:00', timeFormat)
	},
	{
		title: 'Opening Ceremony',
		time: dayjs('2/24/2023 11:00', timeFormat),
		end: dayjs('2/24/2023 11:30', timeFormat)
	},
	{
		title: 'Hacking Begins',
		time: dayjs('2/24/2023 11:30', timeFormat)
	},
	{
		title: 'Team Building',
		time: dayjs('2/24/2023 11:30', timeFormat),
		end: dayjs('2/24/2023 12:00', timeFormat)
	},
	{
		...
		time: dayjs('2/24/2023 12:15', timeFormat),
		end: dayjs('2/24/2023 12:45', timeFormat)
	},
	{
		title: 'Submit Check-In Form',
		time: dayjs('2/24/2023 13:00', timeFormat)
	},
	{
		title: 'Lunch',
		time: dayjs('2/24/2023 13:00', timeFormat),
		end: dayjs('2/24/2023 14:00', timeFormat)
	},
	{
		title: 'Workshops',
		time: dayjs('2/24/2023 14:00', timeFormat),
		end: dayjs('2/24/2023 18:00', timeFormat)
	},
	{
		title: 'Dinner',
		time: dayjs('2/24/2023 19:00', timeFormat),
		end: dayjs('2/24/2023 20:00', timeFormat)
	},
	{
		...
		time: dayjs('2/24/2023 20:00', timeFormat),
		end: dayjs('2/24/2023 21:00', timeFormat)
	},
	{
		title: 'Submit Project Category',
		time: dayjs('2/24/2023 23:30', timeFormat)
	},
	// // Day 2
	{
		title: 'Midnight Snack',
		description: 'Pizza!',
		time: dayjs('2/25/2023 00:00', timeFormat)
	},
	{
		title: 'Breakfast',
		description:
			'Einstein Bros. Bagels: Honey, Blueberry, Chocolate Chip, Cinnamon Raisin, Plain, Everything<br /><br />Blueberry Muffins',
		time: dayjs('2/25/2023 06:00', timeFormat),
		end: dayjs('2/25/2023 08:00', timeFormat)
	},

	{
		title: 'Hacking Ends',
		time: dayjs('2/25/2023 08:00', timeFormat)
	},
	{
		title: 'Judging',
		description:
		...
		time: dayjs('2/25/2023 08:30', timeFormat),
		end: dayjs('2/25/2023 11:00', timeFormat)
	},
	{
		title: 'Closing Ceremony',
		time: dayjs('2/25/2023 11:30', timeFormat),
		end: dayjs('2/25/2023 12:00', timeFormat)
	},
	{
		title: 'Hackathon Ends',
		time: dayjs('2/25/2023 12:00', timeFormat)
	}
];
